$(document).ready(function(){
	...
	const api_category_list = localStorage.getItem('api_url') + '/index.php?c=api&method=category_list&page=1&limit=999';
...
function refresh_category() {
	...
	//获取API地址和token
	api_category_list = localStorage.getItem('api_url') + '/index.php?c=api&method=category_list&page=1&limit=999';
